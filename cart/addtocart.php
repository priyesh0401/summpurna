  ...
  <?php check_message(); ?>
      <div class="">
        <div class="panel panel-default">
          ...
          <div>Every products has a mininum price of &#8377 50 each to be able to order.</div>
      <div class="table-responsive">
       <div  class="fixnmix_scroll_carttwo" >
         ...
         <tbody > 
            ...
            ?>
                      <tr>
                        ...
                        <td>&#8377 <output id="Osubtot<?php echo $result->PRODUCTID ?>"><?php echo   $_SESSION['fixnmix_cart'][$i]['price'] ; ?></output>
        ...
        ?>
                  ...
                  <table  >
                  <tfoot >
                     <strong><h1 align="right">Total Price : &#8377 <span style="margin-right:3%"  id="sum"></span></h1></strong></td>
