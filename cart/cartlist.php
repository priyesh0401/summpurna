                ...
                <div class="panel panel-default panel-shadow">
                    ...
                    <div class="table-responsive">
                         ...
                         <body onload=" totalprice(); ">
                             ...
                             <?php
                              ...
                              <form id="form" action="cart/controller.php?action=edit" method="POST"  
                                  ...
                                  <div class="column4">                                  
                                    ...
                                    <div style="float: left; width:50px">&nbsp;&nbsp;&#8377<span id="price1"><?php echo $result->PRICE; ?></span></div>
                                    <div  id="test" style="float: right; width:50px">&#8377<output name="TOTAL" for="QTY price"></output></div>                                     
                                  </div>
                              </form> 
                            ...
                            <tr >  
                            <td>                               
                             <div class="culomn4"><div style="float: right;"><h1> Total Price : &#8377<span id="sum">0</span></h1></div></div>
                            </td>                        
