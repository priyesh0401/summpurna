          ...
          <div class="col-sm-6">
            <div class="contactinfo">
              <ul class="nav nav-pills">
                <li><a href="#"><i class="fa fa-phone"></i>+91 8989024022</a></li>
                <li><a href="#"><i class="fa fa-envelope"></i> Sumpurna022@gmail.com</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-md-4 clearfix">
            <div class="logo pull-left">
              <a href="<?php echo web_root ?>"><img src="images/home/logo.jpg" style="width:250px; height:140px;" alt="" /></a>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-sm-2">
            <div class="companyinfo">
              <h2><span>Sum</span>-Purna</h2>
              <p>free home delievery for 1st three customer</p>
            </div>
          </div>
          <div class="col-sm-7">
            <div class="col-sm-6">
          ...
          <div class="col-sm-3">
            <div class="address">
              ...
              <p>H.no. 264, P.N.B Colony Near Damohnaka ,Jabalpur</p>
            </div>
          </div>
        </div>
      </div>
